...
namespace Nop.Services.Tests.Directory
{
    ...
    public class MeasureServiceTests : ServiceTest
    {
        ...
        {
            var measureDimensions = TestsData.CreateMeasureDimensions(1, 0.08333333M, 0.0254M, 25.4M);
            ...
            var measureWeights = TestsData.CreateMeasureWeights(16M, 1, 0.45359237M, 453.59237M);
