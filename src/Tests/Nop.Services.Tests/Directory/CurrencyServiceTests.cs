...
namespace Nop.Services.Tests.Directory
{
    ...
    public class CurrencyServiceTests : ServiceTest
    {
        ...
        {
            currencyUSD = TestsData.CreateCurrency(rate: 1.2M);
            currencyEUR = TestsData.CreateCurrency(2, "Euro", "EUR", 1, "", "€0.00");
            currencyRUR = TestsData.CreateCurrency(3, "Russian Rouble", "RUB", 34.5M, "ru-RU");
