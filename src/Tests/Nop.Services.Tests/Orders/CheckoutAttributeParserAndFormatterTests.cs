...
namespace Nop.Services.Tests.Orders
{
    ...
    public class CheckoutAttributeParserAndFormatterTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            var workingLanguage = TestsData.GetLanguage;
