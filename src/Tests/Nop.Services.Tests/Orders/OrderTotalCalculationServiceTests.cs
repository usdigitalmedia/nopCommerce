...
namespace Nop.Services.Tests.Orders
{
    ...
    public class OrderTotalCalculationServiceTests : ServiceTest
    {
        ...
        private IList<ShoppingCartItem> GetShoppingCartItems(Customer customer, bool isFreeShipping = true, decimal price1 = 12.34M, decimal price2 = 21.57M)
        {
            ...
            var sci2 = TestsData.GetShoppingCartItem(product2, customer);
            sci2.Quantity = 3;
        ...
        {
            var sci1 = TestsData.GetShoppingCartItem(3, 5.5M, customer:customer);
            var sci2 = TestsData.GetShoppingCartItem(4, 6.5M, customer: customer);
            //sci3 is not shippable
            var sci3 = TestsData.GetShoppingCartItem(5, 7.5M, false, customer);
        ...
        private static Discount GetDiscount
        {
            get
            {
                ...
                discount1.RequiresCouponCode = false;
                discount1.DiscountAmount = 3;
                discount1.DiscountType = DiscountType.AssignedToOrderSubTotal;
                return discount1;
            }
        }
        ...
        {
            _orderTotalCalcService.IsFreeShipping(GetShoppingCartItems(TestsData.GetCustomer())).ShouldEqual(true);
        }

        [Test]
        public void Shipping_should_not_be_free_when_some_of_shoppingCartItems_are_not_marked_as_freeShipping()
        {
            var cart = GetShoppingCartItems(TestsData.GetCustomer());
        ...
        public void Shipping_should_be_free_when_customer_is_in_role_with_free_shipping()
        {
            ...
            var customerRole1 = TestsData.GetCustomerRole("");
            var customerRole2 = TestsData.GetCustomerRole("");
        ...
        public void Can_get_shipping_total_discount_excluding_tax()
        {
            ...
            //discounts
            var discount1 = TestsData.GetDiscount;
            discount1.DiscountType = DiscountType.AssignedToShipping;
            discount1.DiscountAmount = 3;
            discount1.UsePercentage = false;
