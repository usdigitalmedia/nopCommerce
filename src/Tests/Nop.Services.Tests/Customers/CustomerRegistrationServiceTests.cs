...
namespace Nop.Services.Tests.Customers
{
    ...
    public class CustomerRegistrationServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            var customer1 = TestsData.GetCustomer("Registered");
            ...
            var customer2 = TestsData.GetCustomerByName("test", "Registered");
            var customer3 = TestsData.GetCustomerByName("user", "Registered", _encryptionService.EncryptText("password"), PasswordFormat.Encrypted);
            var customer4 = TestsData.GetCustomerByName("registered", "Registered");
            var customer5 = TestsData.GetCustomerByName("notregistered");
