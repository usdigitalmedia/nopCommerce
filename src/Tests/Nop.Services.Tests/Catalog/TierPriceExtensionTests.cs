...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class TierPriceExtensionTests : ServiceTest
    {
        ...
        public void Can_remove_duplicatedQuantities()
        {
            ...
            {
                //will be removed
                TestsData.CreateTierPrice(price:150),
                //will stay
                TestsData.CreateTierPrice(price:100, id: 2),
                //will stay
                TestsData.CreateTierPrice(price:300, quantity:3, id: 3),
                //will stay
                TestsData.CreateTierPrice(price:250, quantity:4, id: 4),
                //will be removed
                TestsData.CreateTierPrice(price:300, quantity:4, id: 5),
                 //will stay
                TestsData.CreateTierPrice(price:350, quantity:5, id: 6)
            };
