...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class ProductExtensionTests : ServiceTest
    {
        ...
        public void Can_calculate_total_quantity_when_we_do_not_use_multiple_warehouses()
        {
            ...
            product.ProductWarehouseInventory.Add(TestsData.GetProductWarehouseInventory(product, warehouseId: 1,
                stockQuantity: 2));
            product.ProductWarehouseInventory.Add(TestsData.GetProductWarehouseInventory(product, warehouseId: 2,
                stockQuantity: 8));
            product.ProductWarehouseInventory.Add(TestsData.GetProductWarehouseInventory(product, warehouseId: 3,
                stockQuantity: -2));
