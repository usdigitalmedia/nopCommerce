...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class ProductAttributeParserTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            //color (dropdownlist)
            pa1 = TestsData.GetProductAttribute(name: "Color");
            pam1_1 = TestsData.GetProductAttributeMapping(product, 11, "Select color:", productAttribute: pa1);
            pav1_1 = TestsData.GetProductAttributeValue(11, "Green", pam1_1);
            pav1_2 = TestsData.GetProductAttributeValue(12, "Red", pam1_1);
            pam1_1.ProductAttributeValues.Add(pav1_1);
            pam1_1.ProductAttributeValues.Add(pav1_2);

            //custom option (checkboxes)
            pa2 = TestsData.GetProductAttribute(2, "Some custom option");
            pam2_1 = TestsData.GetProductAttributeMapping(product, 21, "Select at least one option: ", AttributeControlType.Checkboxes, pa2);
            pav2_1 = TestsData.GetProductAttributeValue(21, "Option 1", pam2_1);
            pav2_2 = TestsData.GetProductAttributeValue(22, "Option 2", pam2_1);
            pam2_1.ProductAttributeValues.Add(pav2_1);
            pam2_1.ProductAttributeValues.Add(pav2_2);

            //custom text
            pa3 = TestsData.GetProductAttribute(3, "Custom text");
            pam3_1 = TestsData.GetProductAttributeMapping(product, 31, "Enter custom text: ", AttributeControlType.TextBox, pa3);
