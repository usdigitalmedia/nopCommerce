...
namespace Nop.Core.Tests.Domain.Catalog
{
    ...
    public class ProductExtensionTests
    {
        ...
        {
            var ids = TestsData.GetProduct.ParseRequiredProductIds();
        ...
        {
            TestsData.GetProduct.IsAvailable(new DateTime(2010, 01, 03)).ShouldEqual(true);
        }

        [Test]
        public void Should_not_be_available_when_startdate_is_greater_than_somedate()
        {
            TestsData.GetProduct.IsAvailable(new DateTime(2009, 12, 31)).ShouldEqual(false);
        }
        ...
        {
            TestsData.GetProduct.IsAvailable(new DateTime(2010, 01, 01)).ShouldEqual(true);
        }

        [Test]
        public void Should_not_be_available_when_enddate_is_less_than_somedate()
        {
            TestsData.GetProduct.IsAvailable(new DateTime(2010, 01, 04)).ShouldEqual(false);
        }
    }
}
