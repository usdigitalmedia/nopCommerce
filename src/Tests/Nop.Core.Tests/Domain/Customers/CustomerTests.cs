...
namespace Nop.Core.Tests.Domain.Customers
{
    ...
    public class CustomerTests
    {
        ...
        {
            var customer = TestsData.GetCustomer("Test system name 1");
        ...
        {
            var customer = TestsData.GetCustomer(SystemCustomerRoleNames.Registered, SystemCustomerRoleNames.Guests);
        ...
        {
            var customer = TestsData.GetCustomer(SystemCustomerRoleNames.Registered, SystemCustomerRoleNames.Administrators);
        ...
        {
            var customer = TestsData.GetCustomer(SystemCustomerRoleNames.Administrators, SystemCustomerRoleNames.Guests);
