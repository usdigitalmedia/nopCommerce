...
namespace Nop.Core.Tests.Domain.Orders
{
    ...
    public class RecurringPaymentTests
    {
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Days, 7);
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Weeks);
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Months);
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Years);
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Days, 7, false);
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Days);
