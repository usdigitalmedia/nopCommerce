...
namespace Nop.Data.Tests.Orders
{
    ...
    public class RecurringPaymentPersistenceTests : PersistenceTest
    {
        ...
        {
            var rp = TestsData.GetRecurringPayment(RecurringProductCyclePeriod.Days, 1);
            rp.Deleted = true;
            rp.InitialOrder = TestsData.GetOrder;
        ...
        public void Can_save_and_load_recurringPayment_with_history()
        {
            ...
            rp.RecurringPaymentHistory.Add(TestsData.GetRecurringPaymentHistory);
            var fromDb = SaveAndLoadEntity(rp);
            fromDb.ShouldNotBeNull();
