...
namespace Nop.Data.Tests.Orders
{
    ...
    public class OrderPersistenceTests : PersistenceTest
    {
        ...
        {
            var order = TestsData.GetOrder;
            order.ShippingAddress = TestsData.GetAddress;
        ...
        public void Can_save_and_load_order_with_usedRewardPoints()
        {
            ...
            order.RedeemedRewardPointsEntry = TestsData.GetRewardPointsHistory;
        ...
        {
            var order = TestsData.GetOrder;
            order.DiscountUsageHistory.Add(TestsData.GetDiscountUsageHistory);
            var fromDb = SaveAndLoadEntity(order);
            fromDb.ShouldNotBeNull();
        ...
        {
            var order = TestsData.GetOrder;
            var gcuh = TestsData.GetGiftCardUsageHistory;
            gcuh.GiftCard = TestsData.GetGiftCard(true, false);
        ...
        {
            var order = TestsData.GetOrder;
            order.OrderNotes.Add(TestsData.GetOrderNote);
            var fromDb = SaveAndLoadEntity(order);
            fromDb.ShouldNotBeNull();
        ...
        {
            var order = TestsData.GetOrder;
            order.OrderItems.Add(TestsData.GetOrderItem);
            var fromDb = SaveAndLoadEntity(order);
            fromDb.ShouldNotBeNull();
        ...
        {
            var order = TestsData.GetOrder;
            order.Shipments.Add(TestsData.GetShipment);
            var fromDb = SaveAndLoadEntity(order);
            fromDb.ShouldNotBeNull();
